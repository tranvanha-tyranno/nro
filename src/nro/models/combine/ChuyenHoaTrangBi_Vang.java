 ...
 * @author By Mr Blue
 */
public class ChuyenHoaTrangBi_Vang {

    public static void chuyenHoaTrangBiVang(Player player) {
    ...
    private static boolean isTrangBiGoc(Item item) {
        return isDoLuongLong(item) || isDoJean(item) || isDoZelot(item) || isDoThanXD(item) || isDoThanTD(item) || isDoThanNM(item);
    }
